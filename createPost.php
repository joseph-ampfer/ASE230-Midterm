      ...
      <div class="col-md-10 offset-md-1">
        <div class="post-details-cover post-has-full-width-image">
          <div class="post-thumb-cover">
            <div class="post-thumb"> <img src="" alt="" class="img-fluid mx-auto d-block"> </div>
            ...
            <div class="post-meta-info">
              ...
              <div class="title">
                <h2><input required type="text" class="w-100" name="postTitle" placeholder="Project Title" value=""></h2>
              </div>
              <ul class="nav meta align-items-center">
                <li class="meta-author"> <img src="" alt="" class="img-fluid"> <a href="#"></a> </li>
                <li class="meta-date"><a href="#">   </a></li>
                <!-- <li> 2 min read </li> -->
                <li class="meta-comments"><a href="#toComments"><i class="fa fa-comment"></i>   </a></li>
              </ul>
            </div>
          ...
          <input required 
            ...
            data-blacklist='badwords, asdf'
          />
          <label style="margin-top: 50px;" for="postImage"><strong>Post Image</strong></label>
