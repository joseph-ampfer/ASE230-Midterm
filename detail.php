                                ...
                                <ul class="nav nav-menu">
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="sub-menu">
                                                    <li>
                                                        <a href="blog-list-sidebar.html">List Sidebar</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-list-full-width.html">List Full Width</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-grid-sidebar.html">Grid Sidebar</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-grid-2-col.html">Grid v2</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-grid-3-col.html">Grid v3</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-overlay.html">Blog Overlay</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-card-v1.html">Blog Card v1</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog-card-v2.html">Blog Card v2</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="sub-menu">
                                                    <li>
                                                        <a href="blog-details.html">Default Style</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="blog-details-slide.html">Slide Post</a>
                                                    </li>
                                                    <li>
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a href="search-result.html">Search Results</a>
                                            </li>
                                            <li>
            ...
            <div class="row">
                <div class="col-lg-8 pb-80">
                    <div class="post-details-cover">
                        ...
                        <button class="btn btn-comment" type="button" data-toggle="collapse" data-target="#commentToggle" aria-expanded="false" aria-controls="commentToggle">Hide Comments (4) </button>
                            ...
                            <ul class="post-all-comments">
                                    ...
                                    <div class="single-post-comment">
                                        ...
                                        <div class="comment-content">
                                            <div class="comment-author-name">
                                                <h6>Don Norman</h6>
                                                <span>5 Jan 2019 at 6:40 pm </span>
                                            </div>
                                        ...
                                        <li class="single-comment-wrapper">
                                            <div class="single-post-comment">
                                                ...
                                                <div class="comment-content">
                                                    <div class="comment-author-name">
                                                        <h6>Helen Sharp</h6>
                                                        <span>5 Jan 2019 at 6:58 pm </span>
                                                    </div>
                                ...
                                <li class="single-comment-wrapper">
                                    <div class="single-post-comment">
                                        ...
                                        <div class="comment-content">
                                            <div class="comment-author-name">
                                                <h6>Pamela Pavliscak</h6>
                                                <span>5 Jan 2019 at 6:48 pm </span>
                                            </div>
                                            <p>On recommend tolerably my belonging or am. Mutual has cannot beauty indeed now back sussex merely you. It possible no husbands jennings offended.</p>
                                            <a href="#" class="reply-btn">Reply</a>
                                        </div>
                                ...
                                <li class="single-comment-wrapper">
                                    <div class="single-post-comment">
                                        ...
                                        <div class="comment-content">
                                            <div class="comment-author-name">
                                                <h6>Jerrard Spool</h6>
                                                <span>5 Jan 2019 at 6:52 pm </span>
                                            </div>
                                            <p>On recommend tolerably my belonging or am. Mutual has cannot beauty indeed now back sussex merely you. It possible no husbands jennings offended.</p>
                                            <a href="#" class="reply-btn">Reply</a>
                                        </div>
                            ...
                            <div class="widget-content">
                                <div class="featured-post">
                                    ...
                                    <div class="featured-post-title">
                                        <h6>
                                            <a href="blog-details.html">Guide To Experiencing The Magical Sabino Canyon In Tucson</a>
                                        </h6>
                                    </div>
                                </div>
                                <div class="featured-post">
                                    ...
                                    <div class="featured-post-title">
                                        <h6>
                                            <a href="blog-details.html">Inspired To Move: Celebrating Dance and Black History Month</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="widget widget-instagram">
                            ...
                            <div class="widget-content">
                                <ul class="insta-gallery">
                                    <li>
                                        <a href="#">
                                            <img src="assets/images/sidebar/instagram/1.jpg" alt="" class="img-fluid">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="assets/images/sidebar/instagram/2.jpg" alt="" class="img-fluid">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="assets/images/sidebar/instagram/3.jpg" alt="" class="img-fluid">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="assets/images/sidebar/instagram/4.jpg" alt="" class="img-fluid">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="assets/images/sidebar/instagram/5.jpg" alt="" class="img-fluid">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="assets/images/sidebar/instagram/6.jpg" alt="" class="img-fluid">
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="wmcp-item">
                                        <div class="wmc-post">
                                            ...
                                            <div class="wmc-post-title">
                                                <h6>
                                                    <a href="blog-details.html">Understanding The Background Of Fashion </a>
                                                </h6>
                                            </div>
                                        </div>
                                        <div class="wmc-post">
                                            ...
                                            <div class="wmc-post-title">
                                                <h6>
                                                    <a href="blog-details.html">12-inch MacBook Refurb $830, Apple Watch Series</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row align-items-center footer">
                    ...
                    <div class="col-md-4 order-md-3 order-3">
                        <div class="footer-cradit text-center text-md-right">
                            <p>
                                © 2019 <a href="index.html">Themelooks.</a>
                            </p>
                        </div>
                    </div>
                </div>
